...
export const AppDownloadImg = ({ className }: IClassName) => (
  <div className={`flex justify-start items-center w-full ${className}`}>
    <Link href="https://play.google.com/store/apps/details?id=com.instagram.barcelona&hl=en&gl=US" className="w-[50%]" target="_blank">
      <Image className="w-full h-auto" src={playStore} alt="" />
    </Link>
    <Link href="https://play.google.com/store/apps/details?id=com.instagram.android&hl=en&gl=US" className="w-[50%]" target="_blank">
